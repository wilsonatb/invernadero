...
<body>
    ...
    <div class="grid-submenu">
        ...
        <a href="<?php echo constant('URL'); ?>login/etapa" class="boton__submit" class=grid-item>Seleciona una Etapa</a>
...
<!-- librerias apra graficas dinamicas -->
    
    

    
<!-- librerias apra graficas estaticas -->
